...
# Generates A (remarquee) and B (remarks reference) PDFs for cpage-pdf.rmdoc.
#
# Usage:
#   bash .../05-generate-a-vs-b-pdfs-cpage-pdf.sh
#
# Outputs:
...
FIXTURE="$REMARQUEE/cmd/remarquee-ui/testdata/cpage-pdf.rmdoc"
