...
- [x] 3. Phase 3: wire `--annotations-only` flag in cmd/remarquee/cmds/rmdoc/render_v6.go + glaze field + CLI tests
- [x] 4. Phase 3b: wire `--annotations-only` flag in cmd/remarquee/cmds/rmdoc/render_v6_png.go (scope extension per user)
- [x] 5. Phase 4: README/help updates + manual validation on TTC Garden workbook via --cloud
- [x] 6. Full test suite green (`go test ./... -count=1`) and lint clean
